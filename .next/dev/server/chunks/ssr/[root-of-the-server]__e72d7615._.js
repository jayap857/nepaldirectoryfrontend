...
const signup = async (signupData)=>{
    try {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/register/", payload);
...
const AuthProvider = ({ children })=>{
    ...
    const checkAuth = async ()=>{
        ...
        if (token) {
            try {
                ...
                try {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].refreshToken();
    ...
    const signup = async (userData)=>{
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].signup(userData);
...
const businessService = {
   ...
   */ patchBusiness: async (id, businessData)=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/businesses/${id}/`, businessData, config);
            return response.data;
        } catch (error) {
            throw new Error(handleApiError(error, 'Failed to update business'));
        }
   ...
   */ deleteBusiness: async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/businesses/${id}/`);
        } catch (error) {
   ...
   */ uploadBusinessImage: async (id, imageFile, caption = '', isPrimary = false)=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/businesses/${id}/upload_image/`, formData);
            return response.data;
        } catch (error) {
   ...
   */ getBusinessReviews: async (id, params = {})=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/businesses/${id}/reviews/`, {
                params
            });
            return response.data;
        } catch (error) {
   ...
   */ contactBusiness: async (businessId, message)=>{
    ...
    createCategory: async (categoryData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/categories/', categoryData);
            return response.data;
        } catch (error) {
    ...
    updateCategory: async (id, categoryData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/categories/${id}/`, categoryData);
            return response.data;
        } catch (error) {
    ...
    deleteCategory: async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/categories/${id}/`);
        } catch (error) {
   ...
   */ getMyBusinesses: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/my-businesses/');
            return response.data;
        } catch (error) {
   ...
   */ getMyReviews: async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/my-reviews/');
            return response.data;
        } catch (error) {
...
const __TURBOPACK__default__export__ = businessService;
}),
...
;
function HomePage() {
    const { user, isAuthenticated, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AuthContext"]);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const [topBusinesses, setTopBusinesses] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const fetchHomeData = async ()=>{
        try {
            const [topRated, cats, stats] = await Promise.all([
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$businessService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getTopRatedBusinesses("all", 6),
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$businessService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getPublicCategories(),
                __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$businessService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].getStatistics()
            ]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        categories.length > 8 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e72d7615._.js.map